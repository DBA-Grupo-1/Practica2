...
public class Satellite extends SuperAgent {
	 ...
	 * La forma de actuar en este protocolo es:
	 * - Comprobar qué información están pidiendo.
	 * - Consultarla en la Base de Conocimiento.
	 * - Meterla en el contenido de la respuesta.
	 * - Enviar la respuesta.
	 * @author Ismael
	 * @param msg
	 */
